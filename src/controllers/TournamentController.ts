...
class TournamentController {
    public static async getAllTournaments(
        ...
        try {
            ...
            const response : JSONResponse = {success: true, message:"OK", data: tournaments};
    ...
    public static async createTournament(
        ...
        try {
            ...
            const tournament = await TournamentService.createTournament(tournamentDTO);
            const response : JSONResponse = {success: true, message:"Tournament created", data: tournament};
